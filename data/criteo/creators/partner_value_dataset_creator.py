...
class PartnerValueDatasetCreator(BaseCreator):
    ...
    def __init__(self, config: DictConfig) -> None:
        super().__init__(config, "criteo_partner_values_impressions.csv", "criteo_partner_values_conversions.csv")
    ...
    def create_conversions(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        conversions["SalesAmountInEuro"] = conversions["SalesAmountInEuro"].round(
            decimals=0
        )
